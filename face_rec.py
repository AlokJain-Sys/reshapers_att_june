...
# Never commit your .env file to version control (like Git) 
    ...
    def face_prediction(self,test_image, dataframe,feature_column,
        ...
        for res in results:
            ...
            #Send SMS only if this is the first time the person is detected today
                ...
                print(seen_today)
                if text_gen not in seen_today:
                #Function call (filter by name and role)
                    #result_df=retrive_data4(name='contact1:register', person_name=text_gen, role='Staff')
                    print("Retrive4")
                    result_df1=""
                    if result_df1 !='':
                        

                        mobile_number = '91'+result_df1['Mobile'].iloc[0]
